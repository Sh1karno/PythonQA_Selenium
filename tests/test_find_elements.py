...
class TestFindElements:
    ...
    def test_find_elements_catalog_page(self, browser, url):
        browser.open("/index.php?route=product/category&path=20")
    ...
    def test_find_elements_product_page(self, browser, url):
        browser.open("/index.php?route=product/product&path=57&product_id=49")
    ...
    def test_find_elements_login_page(self, browser, url):
    ...
    def test_find_elements_admin_login_page(self, browser, url):
        browser.open("/admin/")
